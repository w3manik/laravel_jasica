        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 text-center">
                    <h2 class="breadcrumb-title">Contuct Us</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="contact-info">
                                <div class="single-contact">
                                    <div class="icon-box">
                                        <img src="{{ asset('websit/images/icons/4.png') }}" alt="">
                                    </div>
                                    <div class="info-box">
                                ...
                                <div class="single-contact">
                                    <div class="icon-box">
                                        <img src="{{ asset('websit/images/icons/5.png') }}" alt="">
                                    </div>
                                    <div class="info-box">
                                ...
                                <div class="single-contact">
                                    <div class="icon-box">
                                        <img src="{{ asset('websit/images/icons/6.png')}}" alt="">
                                    </div>
                                    <div class="info-box">
                        ...
                        <div class="col-lg-7">
                            <div class="contact-form">
                                ...
                                <form class="contact-form-style" action="{{ url('/contact/submit') }}" method="post">
                                    @csrf
                                    <div class="row">
