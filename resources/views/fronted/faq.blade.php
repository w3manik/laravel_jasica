...
{{--
                            <div class="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
                                <div class="panel-heading my-account-title">
                                    <h3 class="panel-title"><span>{{ $faq->id }}.</span> <a data-bs-toggle="collapse" href="#my-account-{{ $faq->id }}" class="collapsed" aria-expanded="true">Mauris congue
                                            euismod purus at semper?</a></h3>
                                </div>
                                <div id="my-account-{{ $faq->id }}" class="panel-collapse collapse show" data-bs-parent="#faq">
                            ...
                            <div class="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
                                <div class="panel-heading my-account-title">
                                    <h3 class="panel-title"><span>{{ $loop->index+1 }}</span> <a data-bs-toggle="collapse" href="#my-account-{{ $faq->id }}" aria-expanded="false" class="collapsed">{{ $faq->faq_title }}</a></h3>
                                </div>
                                <div id="my-account-{{ $faq->id }}" class="panel-collapse collapse" data-bs-parent="#faq">
                                    <div class="panel-body">{{ $faq->faq_message }}
                                    </div>
                                </div>
                            </div>
                            @endforeach
