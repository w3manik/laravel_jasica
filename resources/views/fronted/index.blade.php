                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                            <div class="hero-slide-content hero-slide-content-2 slider-animated-1">
                                ...
                                <h2 class="title-1">{{ $baner->title }}<br></h2>
                                <a href="shop-left-sidebar.html" class="btn btn-lg btn-primary btn-hover-dark">{{ $baner->buton_name  }} <i class="fa fa-shopping-basket ml-15px" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{ asset('uplodes/baner') }}/{{ $baner->baner_pic }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="tab-content mb-30px0px">
                    ...
                    <div class="tab-pane fade show active" id="tab-product--all">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="{{ url('/produt/details') }}/{{ $product->id }}" class="image">
                                            <img src="{{ asset('uplodes/product') }}/{{ $product->product_image }}" alt="Product" />
                                        </a>
                                        <span class="badges">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="{{ url('/produt/details') }}/{{ $product->id }}">{{ $product->product_name }}</a>
                                        </h5>
                                        <span class="price">
                    ...
                    <div class="tab-pane fade" id="category{{ $category->id }}">
                        <div class="row">
                            @foreach (App\Models\product::where('category_id', $category->id)->get() as $shproduct)
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                data-aos-delay="200">
                                <!-- Single Prodect -->
                                <div class="product">
                                    <div class="thumb">
                                        <a href="{{ url('/produt/details') }}/{{ $shproduct->id }}" class="image">
                                            <img src="{{ asset('uplodes/product') }}/{{ $shproduct->product_image }}" alt="Product" />
                                        </a>
                                        <span class="badges">
                                            <span class="new">New</span>
                                        </span>
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="{{ url('/produt/details') }}/{{ $shproduct->id }}">{{ $shproduct->product_name }}</a>
                                        </h5>
                                        <span class="price">
                                            <span class="new">{{ $shproduct->product_price }}</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-auto col-md-auto col-12">
                <ul class="product-tab-nav nav">
                    ...
                    @foreach ($categories as $category)
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#category{{ $category->id }}">{{ $category->category_name }}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="col">
                <div class="tab-content top-borber">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{ url('/produt/details') }}/{{ $product->id }}">{{ $product->product_name }}
                                                </a>
                                            </h5>
                                            <span class="price">
                    ...
                    <div class="tab-pane fade" id="category{{ $category->id }}">
                        <div class="new-product-slider swiper-container slider-nav-style-1 small-nav">
                            <div class="new-product-wrapper swiper-wrapper">
                                @foreach(App\Models\product::where('category_id', $category->id)->get() as $neprdt)
                                <div class="new-product-item swiper-slide">
                                    <!-- Single Prodect -->
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{ asset('uplodes/product') }}/{{ $neprdt->product_image }}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="single-product.html">{{ $neprdt->product_name }}
                                                </a>
                                            </h5>
                                            <span class="price">
                                                <span class="new">{{ $neprdt->product_price }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="{{ url('/blog/details') }}/{{ $blog->id }}"><img src="{{ asset('uplodes/blog') }}/{{ $blog->blog_img }}"
                                class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
                            <a class="blog-date height-shape" href="#"><i class="fa fa-calendar"
                                    aria-hidden="true"></i> {{ $blog->blog_validity }}</a>
                            <a class="blog-mosion" href="#"><i class="fa fa-commenting" aria-hidden="true"></i> 1.5
                                K</a>
                        </div>
                        <h5 class="blog-heading"><a class="blog-heading-link"
                                href="{{ url('/blog/details') }}/{{ $blog->id }}">{{ $blog->title }}</a></h5>

                        <a href="{{ url('/blog/details') }}/{{ $blog->id }}" class="btn btn-primary blog-btn"> Read More<i
