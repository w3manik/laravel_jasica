...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{ asset('websit/images/favicon/favicon.ico')}}" type="image/png">
    ...
    <link rel="stylesheet" href="{{ asset('websit/css/vendor/vendor.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('websit/css/plugins/plugins.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('websit/css/slick.css') }}" />
    <link rel="stylesheet" href="{{ asset('websit/css/style.min.css') }}">

    <!-- Main Style -->
    <!-- <link rel="stylesheet" href="{{ asset('websit/css/style.css') }}" /> -->
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{ asset('websit/images/logo/logo.png') }}" alt="Site Logo" /></a>
                        </div>
                    </div>
                        ...
                        <div class="main-menu">
                            <ul>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            <ul class="d-block">
                                                ...
                                                <li class="title"><a href="{{ url('/produt/shop') }}">Shop Page</a></li>
                                            ...
                                            <ul class="d-block">
                                                ...
                                                <li><a href="{{ url('/privecy') }}">Privacy Policy</a></li>
                                ...
                                <li class="dropdown "><a href="#">Blogs <i class="pe-7s-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ url('/blogarea') }}">Blog Grid Page</a></li>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            {{-- <a href="{{ url('login') }}" class="header-action-btn login-btn" data-bs-toggle="modal"
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ App\Models\Cart::where('gen_cart_id', Cookie::get('gen_cart_id'))->count() }}</span>
    ...
    <div class="inner">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
                @foreach (App\Models\Cart::where('gen_cart_id', Cookie::get('gen_cart_id'))->get() as $wishprod)
                <li>
                    <a href="single-product.html" class="image"><img src="{{ asset('uplodes/product') }}/{{ App\Models\product::find($wishprod->product_id)->product_image }}"
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart">
    <div class="inner">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
                @foreach (App\Models\Cart::where('gen_cart_id', Cookie::get('gen_cart_id'))->get() as $carpordt)
                <li>
                    <a href="{{ url('/produt/details') }}/{{ $carpordt->id }}" class="image"><img src="{{ asset('uplodes/product') }}/{{ App\Models\product::find($carpordt->product_id)->product_image }}" alt="Cart product Image"></a>
                    <div class="content">
                        <a href="{{ url('/produt/details') }}/{{ $carpordt->id }}" class="title">{{ App\Models\product::find($carpordt->product_id)->product_name }}</a>
                        <span class="quantity-price">{{ $carpordt->product_quentity }} x <span class="amount">{{ App\Models\product::find($carpordt->product_id)->product_price * $carpordt->product_quentity }}</span></span>
                        <a href="{{ url('/cart/delete') }}/{{ $carpordt->id }}" class="remove">×</a>
                    </div>
                </li>
                @endforeach
            </ul>
        ...
        <div class="foot">
            <div class="buttons mt-30px">
                <a href="{{ url('/cart') }}" class="btn btn-dark btn-hover-primary mb-30px">Go to cart</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                <div class="footer-row">
                                    <ul class="align-items-center">
                                        <li class="li"><a class="single-link" href="{{ url('/home') }}"> Dashbord </a>
                                        </li>
...
<!-- Use the minified version files listed below for better performance and remove the files listed above -->
<script src="{{ asset('websit/js/vendor/vendor.min.js')}}"></script>
<script src="{{ asset('websit/js/slick.min.js')}}"></script>
<script src="{{ asset('websit/js/plugins/plugins.min.js')}}"></script>

<!-- Main Js -->
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
<script src="{{ asset('websit/js/main.js')}}"></script>
@yield('footer_script')
</body>
